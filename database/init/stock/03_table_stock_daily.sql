...
CREATE TABLE IF NOT EXISTS `stock_daily` (
  ...
  `ps` decimal(12,4) DEFAULT NULL COMMENT '市销率(TTM)',
  `pcf` decimal(12,4) DEFAULT NULL COMMENT '市现率(TTM)',
  `adjust_flag` tinyint(1) DEFAULT NULL COMMENT '复权标志(1-不复权,2-前复权,3-后复权)',
  `trade_status` tinyint(1) DEFAULT NULL COMMENT '交易状态(1-正常,0-停牌)',
  `is_st` tinyint(1) DEFAULT NULL COMMENT '是否ST(1-是,0-否)',
