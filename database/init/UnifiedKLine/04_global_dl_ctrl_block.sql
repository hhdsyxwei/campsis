...
-- 插入默认记录
INSERT INTO `global_dl_ctrl_block` (`task_type`, `primary_pointer_name`, `primary_pointer_value`, `secondary_pointer_name`, `secondary_pointer_value`, `tertiary_pointer_name`, `tertiary_pointer_value`)
